...
API_BASE_URL = "http://10.252.176.14:8001"
...
def main():
    ...
    print(f"数据库2 API总记录: {current_total}, 缓存记录: {last_total}")
    ...
    save_cache(cache)
    print(f"🎉 数据库2新增 {new_count} 条记录，总计 {len(results)} 条")
